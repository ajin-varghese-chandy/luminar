        ...
        <AppBar position="static">
          <Toolbar>
            <IconButton
              ...
              sx={{ mr: 2 }}
            >
              <img width={'40px'} src="https://static.vecteezy.com/system/resources/thumbnails/050/700/033/small_2x/resume-flat-business-management-document-icon-illustration-png.png" alt="" srcset="" />
            </IconButton>
            <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
              <Link to={'/'} className='text-decoration-none text-light fw-bolder' >AI-Resume Builder</Link>
            </Typography>
            <Link to={'/'} className='text-decoration-none text-light m-2' >ALL RESUMES</Link>
            <Link to={'/downloads'} className='text-decoration-none text-light ml-2' >ALL DOWNLOADS</Link>
